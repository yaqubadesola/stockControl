            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="box-header">
                            <h3 class="box-title">@if(isset($account)){{__('Edit')}} @else {{__('Create')}} @endif {{__('Account')}}</h3><a class="btn btn-small btn-primary pull-right" href="{{ URL::to('accounts') }}"><i class="fa fa-list"></i>&nbsp; {{__('List')}}</a>
                        </div>
                    </div>
                </div>
                <div class="box">
