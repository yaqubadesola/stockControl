                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="box-header">
                                <h3 class="box-title">@if(isset($transaction)) {{__('Edit')}}@else{{__('Create')}}@endif  {{__('Transaction')}}</h3><a class="btn btn-small btn-primary pull-right" href="{{ URL::to('transactions') }}"><i class="fa fa-list"></i>&nbsp; List</a>
                            </div>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="box-body" ng-controller="automateController">
                            ...
                            <div class="col-sm-6" >
                                <div class="form-group row">
                                    {{ Form::label('transaction_type', __('Transaction Type') .' *',['class'=>'col-sm-3 text-right']) }}
                                    <div class="col-sm-9">
