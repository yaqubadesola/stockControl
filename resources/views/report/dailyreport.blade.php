        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading hidden-print">{{__('Daily Report')}} <a class="btn btn-small btn-primary pull-right" href="{{ URL::to('reports/dailyreport') }}"><i class="fa fa-list"></i>&nbsp; {{__('List')}}</a></div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{$starting_balance}}
                                            @else
                                            {{ $starting_balance = $exist_report->prev_balance}}
                                            @endif
                                        </td>
                                    </tr>
                                    {{--get daily sales --}}
            ...
            <?php $receiving = DB::table('receivings')->where('id', $receiving_payment->receiving_id)->first();
                  $supplier = DB::table('suppliers')->where('id', $receiving->supplier_id)->first(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong>
                                                {{number_format($starting_balance + $total_sales_payment + $total_customer_payment - $total_receivings_payment - $total_expenses_payment,2)}}
                                        </strong>
                                        </td>
                                    </tr>
                                    </tbody>
                            ...
                            <a href="{{url('reports/createdailyreport')}}" class="btn btn-warning pull-right" onclick="return confirm('Are you Sure You want to close the report!')">Close Report </a>
                                @endif
                            </div>
                        </div>
                    </div>
