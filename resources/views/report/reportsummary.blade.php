        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{__('Expense List')}}</h3><a class="btn btn-small btn-primary pull-right" href="{{ URL::to('reports/dailyreport/create') }}"><i class="fa fa-plus"></i>&nbsp; {{__('Create Daily Report')}}</a>
            </div>
          </div>
            <!-- /.box-header -->
            <div class="box">
