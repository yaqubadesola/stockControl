          ...
          <!-- /.box -->
            ...
            <div class="box">
            	<div class="box-header">
            		<div class="box-header">
		              <h3 class="box-title">@if(!empty($supplier)){{__('Edit')}} @else {{__('Add')}} @endif {{__('Supplier')}}</h3><a class="btn btn-small btn-primary pull-right" href="{{ URL::to('suppliers') }}"><i class="fa fa-list"></i>&nbsp; List</a>
		            </div>
            	</div>
            </div>
          <div class="box">
            ...
            <div class="box-body">
				...
				<div class="col-sm-5">
					<div class="form-group row">
					{{ Form::label('state', trans('supplier.state'), ['class'=> 'col-sm-3 text-right']) }}
					<div class="col-sm-9">
					{{ Form::text('state', Null, array('class' => 'form-control')) }}
					</div>
					</div>
					<div class="form-group row">
					{{ Form::label('zip', trans('supplier.zip'), ['class'=> 'col-sm-3 text-right']) }}
					<div class="col-sm-9">
					{{ Form::text('zip', Null, array('class' => 'form-control')) }}
					</div>
					</div>
					<div class="form-group row">
					{{ Form::label('comments', trans('supplier.comments'), ['class'=> 'col-sm-3 text-right']) }}
					<div class="col-sm-9">
					{{ Form::text('comments', Null, array('class' => 'form-control')) }}
					</div>
					</div>
					<div class="form-group row">
					{{ Form::label('account', trans('supplier.account').' #', ['class'=> 'col-sm-3 text-right']) }}
					<div class="col-sm-9">
					{{ Form::text('account', Null, array('class' => 'form-control')) }}
					</div>
					</div>
					<div class="form-group row">
						{{ Form::label('prev_balance', trans('supplier.prev_balance'),['class'=>'col-sm-3 text-right']) }}
						<div class="col-sm-9">
							@if(isset($supplier))
					...
					<div class="form-group row">
						{{ Form::label('payment', trans('supplier.payment') ,['class'=>'col-sm-3 text-right']) }}
						<div class="col-sm-9">
							@if(isset($supplier))
					...
					<div class="form-group row">
					{{ Form::label('avatar', trans('supplier.choose_avatar'), ['class'=> 'col-sm-3 text-right']) }}
					<div class="col-sm-9">
